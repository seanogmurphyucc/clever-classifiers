...
#do the poisoning here
#put data into a pandas df
#do test train splits to break it into clean and poison sets
#poison the poison set
#
# cluster on: clean only
#             clean plus poisoned
#             X copies of clean concatenated to simulate weighting of entries, then concatenate that with poisoned
#             X = Trust weighting
...
if len(sys.argv) > 1 and sys.argv[1] == '--save':
    ...
    F.write('#    ra           dec       ug      gi      iK      JK     '
            'logP       skew      kurt    magMed    nObs  LCtype  '
